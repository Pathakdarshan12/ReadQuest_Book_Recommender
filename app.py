...
df_books = pd.read_csv('assets/BX-Books.csv', sep=';', encoding='latin-1')
df_books_ratings = pd.read_csv('assets/BX-Book-Ratings-Subset.csv', sep=';', encoding='latin-1')
df_users = pd.read_csv('assets/BX-Users.csv', sep=';', encoding='latin-1')
...
st.write('ReadQuest is an intelligent book recommendation system designed to help users discover their next favorite read.\
          By leveraging user preferences, ratings, and social connections, ReadQuest provides personalized book recommendations.\
          The system utilizes a combination of collaborative filtering and content-based filtering techniques to suggest books that\
